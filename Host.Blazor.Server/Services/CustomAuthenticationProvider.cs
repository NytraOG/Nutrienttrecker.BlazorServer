...
namespace Host.Blazor.Server.Services;

public class CustomAuthenticationProvider : IAuthenticationProviderV2
{
    private readonly IPrincipalProvider principalProvider;

    public CustomAuthenticationProvider(IPrincipalProvider principalProvider) => this.principalProvider = principalProvider;
    ...
    private bool CanHandlePrincipal(IPrincipal user) => user.Identity.IsAuthenticated &&
